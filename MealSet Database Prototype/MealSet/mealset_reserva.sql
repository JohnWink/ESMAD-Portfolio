...
CREATE TABLE `reserva` (
  ...
  KEY `fk_Reserva_Mesa_idx` (`idRestaurante`,`idMesa`),
  CONSTRAINT `fk_Reserva_Cliente1` FOREIGN KEY (`idCliente`) REFERENCES `cliente` (`idCliente`),
  CONSTRAINT `fk_Reserva_Mesa` FOREIGN KEY (`idRestaurante`, `idMesa`) REFERENCES `mesa` (`idMesa`, `idRestaurante`)
...
INSERT INTO `reserva` VALUES (0,0,0,'2020-05-14 12:00:00','John',5,0),(1,1,1,'2020-06-10 00:00:00','Mint',1,0);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `log_reserva` AFTER INSERT ON `reserva` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `log_reserva_Confirmação` AFTER UPDATE ON `reserva` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `log_reserva_Rejeição` AFTER DELETE ON `reserva` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `log_reserva_RejeiçãoAposConfirmação` AFTER DELETE ON `reserva` FOR EACH ROW begin
